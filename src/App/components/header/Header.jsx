  ...
  if (active)
    return (
      <header
        ...
        style={{ background: "var(--background)", height: menu ? "100%" : "" }}
      >
        <div className="display justify-s-b">
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feBlend
                        mode="normal"
                        in2="shape"
                        result="effect1_innerShadow_651_85"
                      />
                    </filter>
                    <filter
                      id="filter1_i_651_85"
          ...
          <div className="display gap">
            <div className="display gap-04 border-r-2">
              <button
                className="display justify-c white h-3 w-3 border-r-100 hover "
                onClick={(e) => setMenu(menu === false ? true : false)}
              >
                <span className="display">
