          ...
          <div className="grid gap-2rem">
            <div className="display gap-1rem">
              <div className="edit-image-link">
                ...
                />
                <div
                  className="display justify-c border-r-100 white shadow border hover-white absolute click p-04"
                  onClick={(e) => document.querySelector("#upload-img").click()}
                >
                  ...
                  <input
                    ...
                    id="upload-img"
                    onChange={(fileInput) => {
                      uploadPhoto(fileInput, User?.email);
                    }}
                  />
                </div>
              </div>
            ...
            <div className="display gap">
              ...
              <div className="display">
                <button
                  className="p-1 h-3 red-secondary hover border-r-1 display gap"
                  onClick={SignOut}
                >
            ...
            <div className="grid gap">
              ...
              <div className="grid gap-1rem">
                <div className="grid white border-r-04 border">
                  <div
                    className="display justify-s-b f-w-600"
                    style={{
                  ...
                  >
                    <span style={{ width: "50%" }} className="p-1">
                      Type
                    </span>
                    <span
                      style={{ minWidth: "20%" }}
                      className="text-align-e p-1"
                    >
                      Montant
                    </span>
                    <span className="text-align-e p-1" style={{ width: "30%" }}>
                      Date
                    </span>
                  </div>
                  {transactions
                    ...
                    .map((transaction, i) => {
                      ...
                      return (
                        <div
                          className="display justify-s-b h-3"
                          key={id}
                          id={i}
                          style={{
                            borderBottom:
                        ...
                        >
                          ...
                          <span
                            style={{ minWidth: "20%", textAlign: "end" }}
                            className={
                              (type === "withdraw" ? "c-green" : "c-blue ") +
                              "p-1"
                            }
                          >
...
const Inputs = ({ props, uneditable }) => {
  ...
  return (
    <div
      className="grid gap"
      style={{ pointerEvents: uneditable ? "none" : "cursor" }}
    >
      <span>{label}</span>
      <input
