        ...
        <Main>
            <div className='login'>
                <div className='login-img'>
                    <img className='border-r-2' height='100%' src='https://images.unsplash.com/photo-1665686306574-1ace09918530?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80' />
                </div>
