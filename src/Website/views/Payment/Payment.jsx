...
export function Stripe({ props }) {
  ...
  const total =
    billingID === "yearly"
      ? plans[planID].price?.[billingID] * 12
      : plans[planID].price?.[billingID];
    ...
    <>
      ...
      >
        <div className="grid gap align-top blocks w-100p">
                ...
                <div className="grid m-b-1">
                  <div className="display justify-s-b m-t-1">
                    ...
                    <div className="display">
                      ...
                      >
                        <span>
                          {ShowCart === true ? "Masquer" : "Afficher"}
                        </span>
                      </button>
                    </div>
                  </div>
          ...
          <CheckoutForm
            props={{ user, MSG, error, planID, billingID, total }}
          />
        </div>
      </form>
    </>
...
export default function Payment() {
  ...
  const stripePromise = loadStripe(
    "pk_test_51HKFx4L8AEDuYjhscUrD37Q7AP9kCKtBF8uG8xO6DCh5FKNrTuyLAecOgxZyXHPtaV4jduDf6fWoJBiGuqjjcK8c00z71QBckl"
  );
