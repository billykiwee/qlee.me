      ...
      <div className="login">
        ...
        <div className="form-block">
          <div className="grid w-100p">
            ...
            <form
              onSubmit={(e) =>
                byEmail(e, userID, setMSG, history, snackBar, redirect)
              }
            >
              ...
              <div className="grid w-100p m-b-1">
                ...
                <div className="div-input white display border border-r-1">
                  ...
                  <img
                    ...
                    onClick={(e) =>
                      setHashPassword(HashPassword === true ? false : true)
                    }
                    width={20}
                    src={
                      HashPassword
